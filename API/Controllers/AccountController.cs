...
public class AccountController(SignInManager<AppUser> signInManager) : BaseApiController
{
    ...
    {
        AppUser user = await signInManager.UserManager.GetUserByEmail(User);

        IdentityResult result = await signInManager.UserManager.ChangePasswordAsync(user, currentPassword, newPassword);
